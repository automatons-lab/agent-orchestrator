...
function DashboardInner({
  ...
  const handleMerge = useCallback(
    async (prNumber: number, projectId: string, owner?: string, repo?: string) => {
      try {
        // projectId disambiguates when the same PR number exists in multiple
        // projects (each repo numbers PRs independently); owner/repo pin the
        // exact repository for multi-PR sessions.
